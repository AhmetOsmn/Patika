...
namespace MiddlewarePractices
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // app.Run(async context => Console.WriteLine("Middleware 2")); // 2 app.Run()'ı 2 kez kullanamayız. Kısa devre yaptırmak için kullanılır.

            // app.Use(async (context,next) => {
            //     Console.WriteLine("Middleware 1 başladı.");
            //     await next.Invoke(); // Eğer async metotun çalışması için başka bir işlem grubunun sonucunun dönmesini beklememiz gerekiyorsa await kullanmamız gerekir.
            //     Console.WriteLine("Middleware 1 sonlanıyor...");
            // });

            // app.Use(async (context,next) => {
            //     Console.WriteLine("Middleware 2 başladı.");
            //     await next.Invoke(); 
            //     Console.WriteLine("Middleware 2 sonlanıyor...");
            // });

            // app.Use(async (context,next) => {
            //     Console.WriteLine("Middleware 3 başladı.");
            //     await next.Invoke(); 
            //     Console.WriteLine("Middleware 3 sonlanıyor...");
            // });
